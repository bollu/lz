...
lean_object* l_higherorder(lean_object*);
lean_object* l_higherorder(lean_object* x_1) {
_start:
{
...
lean_object* initialize_Test_higherorder(lean_object* w) {
lean_object * res;
...
res = initialize_Test_higherorder(lean_io_mk_world());
