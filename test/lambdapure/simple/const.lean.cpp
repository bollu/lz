...
extern "C" {
#endif
lean_object* l_const(lean_object*);
lean_object* _lean_main(lean_object*);
lean_object* l_main___boxed__const__1;
lean_object* l_const___boxed(lean_object*);
lean_object* l_const(lean_object* x_1) {
_start:
{
lean_inc(x_1);
return x_1;
...
lean_object* l_const___boxed(lean_object* x_1) {
_start:
{
lean_object* x_2; 
x_2 = l_const(x_1);
...
lean_object* initialize_Test_const(lean_object* w) {
lean_object * res;
...
res = initialize_Test_const(lean_io_mk_world());
